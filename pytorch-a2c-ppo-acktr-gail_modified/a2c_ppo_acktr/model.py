...
from mlca.helpers.nn import MLP, Flatten
...
class Policy(nn.Module):
    def __init__(self, obs_shape, action_space, device=None, base=None, base_kwargs=None):
        ...
        self.base = base(obs_shape[0], obs_shape, **base_kwargs)

        if action_space.__class__.__name__ == "Discrete":
            num_outputs = action_space.n
            self.dist = Categorical(self.base.output_size, num_outputs, device)
        elif action_space.__class__.__name__ == "Box":
            num_outputs = action_space.shape[0]
            self.dist = DiagGaussian(self.base.output_size, num_outputs, device)
        elif action_space.__class__.__name__ == "MultiBinary":
            num_outputs = action_space.shape[0]
            self.dist = Bernoulli(self.base.output_size, num_outputs, device)
        else:
            raise NotImplementedError
